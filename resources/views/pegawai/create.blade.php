    ...
    <div class="container-fluid">
        <div class="page-title-box">
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">Tambah Pegawai Perpustakaan</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('pegawai.create') }}">Tambah Pegawai Perpustakaan</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 d-flex justify-content-between">
                                <h6 class="font-weight-bold mb-3">Tambah Pegawai</h6>
                            </div>
                                ...
                                <form action="{{ route('pegawai.store') }}" method="post" enctype="multipart/form-data"> @csrf
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukan Nama Pegawai" class="form-control" required id="">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="">Email <span class="text-danger">*</span></label>
                                            <input type="email" name="email" value="{{ old('email') }}" placeholder="Masukan Email Pegawai" class="form-control" required id="">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="no_hp" value="{{ old('no_hp') }}" placeholder="Masukan No HP Pegawai" class="form-control" required id="">
                                        </div>
